...
(defn quantum-computing "//thephoeron.com/ quantum computing page"
  ...
  (tmpl/default-page req {:title "Quantum Computing"}
    (html5
     ...
     [:p "φ-Calculus:" [:br]
      [:span {:style "color: #777;"} "Universal and Scoped φ-Calculi, adapted quantum functional&ndash;process calculi for concurrent hybrid classical/quantum computation. The Scoped φ-Calculus extends the Universal with scoping rules to support an n-dimensional, programmable environment, for namespace, type, and temporal scoping, and additional scoping dimensions."]]
     [:p "BRAKET/Φ:" [:br]
